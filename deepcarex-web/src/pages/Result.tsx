            ...
            >
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-gray-400">Generated by DeepCareX Inference Engine</p>
                    </div>
                ...
                <div className="mt-12 p-4 bg-deepnavy/50 rounded-xl border border-white/5">
                    <p className="text-xs text-gray-500 font-mono flex items-start gap-2">
                        ...
                        DISCLAIMER: This diagnostic prediction is simulated using AI for informational purposes only. DeepCareX is not a certified medical device. Always consult with a qualified healthcare professional before making any medical decisions.
                    </p>
                </div>
            </motion.div>
        </div>
